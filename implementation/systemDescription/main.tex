...
The MediaWiki was dependent on MySQL and PHP to run since it needs somewhere to store data and because it is written in PHP. Therefore MediaWiki was the last thing to install. 
